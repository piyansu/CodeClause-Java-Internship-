...
public class SplashScreenDemo2 {
    JFrame frame;
    JLabel image = new JLabel(new ImageIcon("/icons/logo.png"));
    JLabel text = new JLabel("Generating Tickets....");
    ...
    public SplashScreenDemo2(String name, String date , String time , String selected_cinema , String number , int ticketnumber , int cost) {
    ...
    public void runProgressBar() {
        SwingWorker<Void, Integer> worker = new SwingWorker<Void, Integer>() {
            ...
            protected void done() {
                frame.dispose();
                new ticket(name, date , time , selected_cinema , number , ticketnumber , cost );
            }
        };
